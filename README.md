...
1. [Prepare input data using QGIS (optionally R)](#1-Prepare-input-data) <img src="https://github.com/Luisa-del/Remoteness/blob/main/img/logo_qgis.png" width="100"> <img src="https://github.com/Luisa-del/Remoteness/blob/main/img/logo_r.png"> 
