...
1. [Prepare input data](#1-Prepare-input-data-in-QGIS)
    1. [using QGIS](#1-Prepare-input-data-in-QGIS)  <img src="https://github.com/Luisa-del/Remoteness/blob/main/img/logo_qgis.png" width="20">
    2. [using R](#1-Prepare-input-data-in-R) <img src="https://github.com/Luisa-del/Remoteness/blob/main/img/logo_r.png"> 
